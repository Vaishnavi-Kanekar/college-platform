      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to bottom, transparent 30%, rgba(10,15,30,0.8) 100%)',
          }}
        />
      ...
      >
        ...
        >
          {[
            {
              label: 'Annual Fees',
              value: `₹${((college.total_fees || 0) / 100000).toFixed(1)}L`,
            },
            {
              label: 'Placement',
              value: `${college.placement_percentage || 0}%`,
            },
            {
              label: 'Avg Package',
              value: `${college.avg_package || 0} LPA`,
            },
            {
              label: 'Est.',
              value: college.established?.toString() || 'N/A',
            },
          ].map((stat) => (
            <div
              key={stat.label}
